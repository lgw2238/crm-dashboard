...
type ThemeColorType = 'primary' | 'secondary' | 'tertiary' | 'info' | 'success' | 'warning' | 'error' | 'dark' | 'light' | 'inverse';

const themeColor: Record<StatusType, ThemeColorType> = {
  'todo': 'warning',
  'inProgress': 'info',
  'done': 'success'
};
          ...
          {edit ? (
            ...
            />
              ...
              <>
                ...
                <Badge themeColor={themeColor[status as StatusType]} style={{ zIndex: 0 }}>
