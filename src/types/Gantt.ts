export const exampleTaskTypeTaskData = [
    {
        ...
        orderId: 0,
        start: new Date('2025-03-18T00:00:00.000Z'),
        end: new Date('2025-03-22T00:00:00.000Z'),
        ...
        children: [
            {
                ...
                title: 'Design',
                orderId: 2,
                start: new Date('2025-03-02T00:00:00.000Z'),
                end: new Date('2025-03-02T00:00:00.000Z'),
                percentComplete: 1,
                isExpanded: true
                // 'type': 'milestone'
            },
            {
                ...
                orderId: 3,
                start: new Date('2025-03-02T00:00:00.000Z'),
                end: new Date('2025-03-03T00:10:00.000Z'),
...
export const exampleDependencyTypeTaskData = [
    {
        ...
        end: new Date('2025-03-02T10:00:00.000Z'),
        percentComplete: 0.77
    },
    {
        id: 2,
...
export const exampleFlatTaskData = [
    ...
    },
    {
        ...
        orderId: 1,
        start: new Date('2025-03-02T00:00:00.000Z'),
        end: new Date('2025-03-07T00:00:00.000Z'),
    ...
    },
    {
        ...
        orderId: 0,
        start: new Date('2025-03-02T00:00:00.000Z'),
        end: new Date('2025-03-04T00:00:00.000Z'),
        percentComplete: 0.25,
        isExpanded: true,
        reportsTo: 11
    },
    {
        ...
        orderId: 1,
        start: new Date('2025-03-02T00:00:00.000Z'),
        end: new Date('2025-03-03T02:00:00.000Z'),
    ...
    },
    {
        ...
        orderId: 2,
        start: new Date('2025-03-04T00:00:00.000Z'),
        end: new Date('2025-03-07T00:00:00.000Z'),
    ...
    },
    {
        ...
        title: 'Design',
        orderId: 2,
        start: new Date('2025-03-09T00:00:00.000Z'),
        end: new Date('2025-03-14T00:00:00.000Z'),
        percentComplete: 0.6,
        isExpanded: true,
        reportsTo: 7
    },
        ...
        children: [
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        parentId: 11,
                        start: new Date('2025-03-02T00:00:00.000Z'),
                        end: new Date('2025-03-02T02:00:00.000Z'),
                        percentComplete: 0.82,
                        isExpanded: true
                    },
                    {
            ...
            },
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        orderId: 1,
                        parentId: 13,
                        start: new Date('2025-03-17T00:00:00.000Z'),
                        end: new Date('2025-03-18T00:00:00.000Z'),
                        percentComplete: 0.82,
                        isExpanded: true
                    },
                    {
                        ...
                        parentId: 13,
                        start: new Date('2025-03-18T00:00:00.000Z'),
                        end: new Date('2025-03-24T00:00:00.000Z'),
                        percentComplete: 0.5,
                        isExpanded: true
                    },
                    {
                        ...
                        parentId: 13,
                        start: new Date('2025-03-18T00:00:00.000Z'),
                        end: new Date('2025-03-27T00:00:00.000Z'),
                    ...
                    },
                    {
                        ...
                        orderId: 3,
                        parentId: 13,
                        start: new Date('2025-03-27T00:00:00.000Z'),
                        end: new Date('2025-07-02T00:00:00.000Z'),
                        percentComplete: 0.6,
                        isExpanded: true
                    }
            ...
            },
            {
                ...
                orderId: 5,
                parentId: 7,
                start: new Date('2025-03-23T00:00:00.000Z'),
                end: new Date('2025-07-05T00:00:00.000Z'),
                ...
                children: [
                    {
                        ...
                        parentId: 30,
                        start: new Date('2025-03-23T00:00:00.000Z'),
                        end: new Date('2025-03-26T00:00:00.000Z'),
                    ...
                    },
                    {
                        ...
                        orderId: 1,
                        parentId: 30,
                        start: new Date('2025-03-26T00:00:00.000Z'),
                        end: new Date('2025-07-05T00:00:00.000Z'),
                        percentComplete: 0,
                        isExpanded: true
                    }
